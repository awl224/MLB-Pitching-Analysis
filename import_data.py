...
data_dir = Path(__file__).parent / "model_data/pitch_data"
...
# Load batter data
batter_dir = Path(__file__).parent / "model_data/batter_data"
...
batter_df.rename(
    columns={"player_name": "batter_name", "player_id": "batter"}, inplace=True
)
